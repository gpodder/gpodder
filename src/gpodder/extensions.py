...
def call_extensions(return_container=False):
        ...
        def handler(self, *args, **kwargs):
            ...
            for container in self.containers:
                ...
                try:
                    ...
                    if return_container and isinstance(cb_res, list):
                        cb_res = [(x, container) for x in cb_res]
                    elif return_container and cb_res is not None:
                        cb_res = (cb_res, container)
...
class ExtensionManager(object):
    ...
    @call_extensions(return_container=True)
