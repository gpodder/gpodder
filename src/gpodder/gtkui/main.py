...
#        self.treeAvailable.connect('drag-data-get', drag_data_get)
    ...
    def treeview_downloads_show_context_menu(self, event=None):
        ...
        if event is None or event.button == 3:
            ...
            dsec.remove(0)
            if can_force:
                insert_menuitem(0, _('Start download now'), 'app.forceDownload', 'document-save-symbolic')
            else:
                insert_menuitem(0, _('Download'), 'app.download', 'document-save-symbolic')
    ...
    def treeview_available_show_context_menu(self, event=None):
        ...
        if event is None or event.button == 3:
            ...
            psec.remove(1)
            if can_pause:
                insert_menuitem(1, _('Pause'), 'app.pause', 'media-playback-pause-symbolic')
            else:
                insert_menuitem(1, _('Download'), 'app.download', 'document-save-symbolic')
            ...
            if not can_cancel and have_cancel:
                ...
                insert_menuitem(2, _('Cancel'), 'app.cancel', 'process-stop-symbolic')
