...
#        self.LabelWebsite.set_text(self.channel.link)
        self.btn_website_label.set_text(self.channel.link)
...
#        menu.popup(None, None, None, None, event.button, event.time)
    ...
    def on_btnOK_clicked(self, widget, *args):
        self.channel.pause_subscription = self.skip_feed_update_switch.get_active()
        self.channel.sync_to_mp3_player = self.enable_device_sync_switch.get_active()
