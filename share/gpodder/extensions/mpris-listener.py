...
from gpodder.player import PlayerControl
...
class MPRISDBusReceiver(PlayerControl):
    ...
    def on_name_owner_changed(self, connection, sender, path, interface, signal, params_variant, user_data):
        _name, old_owner, new_owner = params_variant.unpack()
    ...
    def PlaybackStarted(self, start_position, total_time, file_uri):
        ...
        self.notify(PlayerControl.SIGNAL_STARTED, start_position, total_time, file_uri)
    ...
    def PlaybackStopped(self, start_position, end_position, total_time, file_uri):
        ...
        self.notify(PlayerControl.SIGNAL_STOPPED, start_position, end_position, total_time, file_uri)

    def PlayerExited(self, file_uri):
        logger.info('PlayerExited: %s', file_uri)
        self.notify(PlayerControl.SIGNAL_EXITED, file_uri)
...
class gPodderExtension:
    ...
    def on_load(self):
        ...
        self.rcvr = MPRISDBusReceiver(bus)
        registry.player_control.register(self.get_rcvr)
    ...
    def on_unload(self):
        ...
        registry.player_control.unregister(self.get_rcvr)
